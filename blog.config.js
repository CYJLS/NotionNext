...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '上士闻道，勤而行之',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '何以杰', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一位在寻求向上突破的青年', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cyjlls.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '成长,生活,创业', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '1755094341@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  WIDGET_PET_LINK:
        ...
        'https://imuncle.github.io/live2d/model/haru/haru_01.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '3zbuxex3z3z05e', // 对应歌单的 id
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '6921aed012785f9a94d37f3575e6bd88', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
